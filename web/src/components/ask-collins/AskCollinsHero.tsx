...
export default function AskCollinsHero({
  ...
  const bg = bannerImage || "/images/banners/ask-collins.jpg";
  const displayTitle = lang === "ta" && titleTa ? titleTa : (title || (lang === "ta" ? "போதகரிடம் கேளுங்கள்" : "Ask Collins"));
  const displaySub = lang === "ta" && subtitleTa ? subtitleTa : (subtitle || (lang === "ta" ? "உங்கள் கேள்விகளுக்கு வேதாகம பதில்கள்" : "Biblical Wisdom & Guidance"));
