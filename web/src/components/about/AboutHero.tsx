...
export default function AboutHero({
  ...
  const displayTitle = lang === "ta" && titleTa ? titleTa : (title || (lang === "ta" ? "எங்களைப் பற்றி" : "About Us"));
  const displaySub = lang === "ta" && subtitleTa ? subtitleTa : (subtitle || (lang === "ta" ? "கிறிஸ்தவ ஐக்கிய சபை" : "Christian Fellowship Church"));
