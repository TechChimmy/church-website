    ...
    <>
      ...
      <style>{`
        ...
        @media (max-width: 400px) {
          .cfc-brand-title { font-size: 11px !important; }
          .cfc-brand-sub { font-size: 7.5px !important; letter-spacing: 0.18em !important; }
        }
          ...
          >
            ...
            <Link href="/" className="flex items-center shrink-0" style={{ textDecoration: "none", gap: 9 }}>
              ...
              <div style={{ whiteSpace: "nowrap" }}>
                <span
                  className="font-playfair cfc-brand-title"
                  style={{
                ...
                <span
                  className="font-lato cfc-brand-sub"
                  style={{
