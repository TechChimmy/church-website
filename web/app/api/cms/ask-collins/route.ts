...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const mappedItems = result.items.map((item: any) => ({
      ...
      answer: item.answer ?? "",
      answerTa: item.answerTa ?? "",
      answerTitle: item.answerTitle ?? "",
      answerTitleTa: item.answerTitleTa ?? "",
...
export async function PATCH(req: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      questionTa: updated.questionTa ?? "",
      consent: updated.consent ?? false,
      videoName: updated.videoName ?? "",
      timestamp: updated.timestamp ?? "",
      answer: updated.answer,
      answerTa: updated.answerTa ?? "",
      answerTitle: updated.answerTitle ?? "",
      answerTitleTa: updated.answerTitleTa ?? "",
